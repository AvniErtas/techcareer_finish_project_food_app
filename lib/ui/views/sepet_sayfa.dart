      ...
      try {
        ...
        for (var urun in sepet) {
          ...
          var gruplanmisUrun = gruplanmisUrunler.putIfAbsent(
            urunAdi,
            () => GruplanmisUrun(
                urunAdi, urunResimAdi, Sayilar.kZeros, int.parse(sepetYemekId)),
          );
                    ...
                    itemBuilder: (context, indeks) {
                      ...
                      return Card(
                        child: ListTile(
                          ...
                          subtitle: Text(
                              "${Metinler.adet}${gruplanmisUrun.toplamAdet}"),
                          trailing: Column(
                            children: [
                              Builder(
                                builder: (context) {
...
class GruplanmisUrun {
  ...
  GruplanmisUrun(
      this.urunAdi, this.urunResimAdi, this.toplamAdet, this.sepetYemekId);
}



/* //!duzenlenmesi lazim guncel sepet
